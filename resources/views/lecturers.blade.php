                            ...
                            <table id="zero-config" class="table table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Name</th>
                                        <th>Role</th>
                                        <th class="no-content" width="30%">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$lecturer->getFormattedName()}}</td>
                                        <td>{{ucfirst($lecturer->role)}}</td>
                                        <td>
                                            <div class="">
                                                <a href="{{'/profile'}}" class="btn btn-primary m-1" 
                                                    onclick="event.preventDefault();
                                                    document.getElementById('profile-form-{{encode($lecturer->id)}}').submit();">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                                    <form id="profile-form-{{encode($lecturer->id)}}" action="{{route('get.profile')}}" method="POST" class="d-none">
                                                        @csrf
                                                        <input type="hidden" name="user_id" value="{{encode($lecturer->id)}}"/>
                                                    </form>
                                                </a>
                                                <a class="btn btn-secondary m-1" href="javascript:void(0);" data-toggle="modal" data-target="#instantDM-{{encode($lecturer->id)}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-square"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <div class="modal fade" id="instantDM-{{encode($lecturer->id)}}" tabindex="-1" role="dialog" aria-labelledby="instantDM-{{encode($lecturer->id)}}-Label" style="display: none;" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="instantDM-{{encode($lecturer->id)}}-Label">Send Direct Message</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form id="instant-dm-form" method="post" action="{{--route('')--}}">
                                                        ...
                                                        <div class="mb-4">
                                                            <h6>Reciepient:
                                                                <span class="text-monospace text-secondary">{{$lecturer->getFormattedName()}}</span>
                                                            </h6>
                                                        </div>
                                                        <div class="mt-2">
                                    ...
                                    @empty
                                    <tr><td colspan="4">No new staff</td></tr>
                                    @endforelse
                                </tbody>
                                <tfoot>
                                    <tr>
