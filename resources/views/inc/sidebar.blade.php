        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu active">
                ...
                <ul class="collapse submenu recent-submenu mini-recent-submenu list-unstyled show" id="announcement" data-parent="#accordionExample">
                    ...
                    <li class="">
                        <a href="#student-annoucement" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <span>Student</span>
                            </div>
                            <div>
                        ...
                        <ul class="pl-3 collapse submenu recent-submenu mini-recent-submenu list-unstyled" id="student-annoucement" data-parent="#student-annoucement">
                            <li>
                                <a href="index2.html"> 400 Level </a>
                            </li>
                            <li>
                                <a href="index2.html"> 300 Level </a>
                            </li>
                            <li>
                                <a href="index2.html"> 200 Level </a>
                            </li>
                            <li>
                                <a href="index2.html"> 100 Level </a>
                            </li>
                        </ul>
                    </li>
                </ul>
