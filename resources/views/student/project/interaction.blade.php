                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-4">
                                <h6>Publicity:
                                    <span class="badge badge-secondary">{{ucwords($supervisor)}}</span>
                                </h6>
                            </div>
                            <div class="mt-2">
                                <form id="post-message" method="post" action="{{ route('postinteractionmessage.student.interaction.project')}}">
                                    @csrf
                                    <div class="form-group">
                                        <input type="hidden" name="supervisory_group_id" value="{{$sgid}}">
                        ...
                        <div class="modal-footer d-flex justify-content-around">
                            ...
                            <button type="submit" form="post-message" class="btn btn-primary">Post</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="input-group">
                            <div class="input-group-prepend show">
                                <button class="btn btn-dark dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">{{ucwords($supervisor)}}</button>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-2">
                                                                <form id="edit-message-{{$interaction['id']}}" method="post" action="{{ route('editinteractionmessage.student.interaction.project')}}">
                                                                    @csrf
                                                                    <div class="form-group">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-2">
                                                                <form id="delete-message-{{$interaction['id']}}" method="post" action="{{ route('deleteinteractionmessage.student.interaction.project')}}">
                                                                    @csrf
                                                                    <input type="hidden" name="message_id" value="{{$interaction['id']}}">
                                                                </form>
                                                            </div>
                    ...
                    <div class="col-12">
                        <div class="widget widget-activity-three">
                            ...
                            <div class="widget-heading">
                                <h5 class="">{{$supervisor}} - Interaction</h5>
                            </div>
