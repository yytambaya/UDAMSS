                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-2">
                                                                <form id="edit-message" method="post" action="{{ route('editinteractionmessage.student.interaction.project')}}">
                                                                    @csrf
                                                                    <div class="form-group">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-2">
                                                                <form id="delete-message" method="post" action="{{ route('deleteinteractionmessage.student.interaction.project')}}">
                                                                    @csrf
                                                                    <input type="hidden" name="message_id" value="{{$interaction['id']}}">
                                                                </form>
                                                            </div>
