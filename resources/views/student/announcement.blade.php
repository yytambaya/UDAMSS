                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mt-2">
                                <form id="post-announcement" method="post" action="{{route('post.level'.$publicity.'.announcement')}}">
                                    @csrf
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered notice-boards mb-4">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a class="btn @if($publicity==4)btn-primary @else btn-outline-primary @endif btn-lg" href="{{route('level4.announcement')}}">400L Notice Board</a>
                                                    </td>
                                                </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    <td>
                                                        <a class="btn @if($publicity==3)btn-primary @else btn-outline-primary @endif btn-lg" href="{{route('level3.announcement')}}">300L Notice Board</a>
                                                    </td>
                                                </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    <td>
                                                        <a class="btn @if($publicity==2)btn-primary @else btn-outline-primary @endif btn-lg" href="{{route('level2.announcement')}}">200L Notice Board</a>
                                                    </td>
                                                </tr>
                                                @endif
                                                ...
                                                @if($isLecturer or $publicity == '1')
                                                    <tr>
                                                        <td>
                                                            <a class="btn @if($publicity==1)btn-primary @else btn-outline-primary @endif btn-lg" href="{{route('level1.announcement')}}">100L Notice Board</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                            </tbody>
